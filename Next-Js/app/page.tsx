        ...
        <nav className={cn(
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              ...
              <Link href="/login" className="px-6 py-2.5 bg-slate-900 dark:bg-white text-white dark:text-slate-900 rounded-xl font-black text-[10px] uppercase tracking-widest transition-all hover:scale-105 active:scale-95 shadow-xl shadow-slate-900/10">{t("heroCTA")}</Link>
            </div>
          </div>
        </nav>
      </div>
          ...
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            <div className="space-y-10 text-center lg:text-left">
              ...
              <div className="flex flex-col sm:flex-row gap-5 justify-center lg:justify-start pt-4">
                <Link href="/login" className="px-10 py-5 bg-teal-600 text-white rounded-2xl font-black text-sm hover:bg-teal-700 transition-all flex items-center justify-center gap-3 shadow-2xl shadow-teal-500/30">
      ...
      <section className="py-32 px-6 bg-white dark:bg-slate-950 text-center">
        <div className="max-w-6xl mx-auto rounded-[4rem] bg-slate-900 dark:bg-white p-20 lg:p-32 text-center space-y-10 relative overflow-hidden shadow-2xl">
           ...
           <div className="flex justify-center pt-6">
              <Link href="/login" className="px-12 py-6 bg-teal-600 text-white rounded-2xl font-black text-xl hover:scale-105 transition-all shadow-2xl flex items-center justify-center gap-4 group">
