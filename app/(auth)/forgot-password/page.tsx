  ...
  return (
    <div className="space-y-8">
      ...
      <form className="space-y-6">
        ...
        <button className="w-full bg-gradient-to-r from-teal-600 to-cyan-600 hover:from-teal-700 hover:to-cyan-700 text-white py-3.5 rounded-xl font-bold text-sm transition-all shadow-md shadow-teal-500/25 flex items-center justify-center gap-2 group">
          Send Reset Link
